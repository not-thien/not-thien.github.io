...
//       What is getting added to the fringe? In what order? BFS - FIFO // DFS - LIFO
...
//       How do we know the graph is no longer a tree? a node may have more than one parent
//       Does Breadth-first Search still find the optimal path? Yes, DFS no longer finds the optimal path
...
//neighbors[3].add(6); neighbors[1].add(4); 
//neighbors[2].add(7);
//neighbors[4].add(5); 
//neighbors[6].add(5); 
//neighbors[5].add(7);
