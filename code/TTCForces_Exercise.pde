...
//  agentPos[3] = new Vec2(420, 500);
//  agentPos[4] = new Vec2(100, 200);
//  goalPos[0] = new Vec2(200,420);
//  goalPos[1] = new Vec2(120,120);
//  goalPos[2] = new Vec2(220,220);
//  goalPos[3] = new Vec2(300, 300);
//  goalPos[4] = new Vec2(400, 400);
  
//  //Vec2 test = new Vec2(0,0);
//  //Vec2 end1 = new Vec2(0,10);
//  //Vec2 vel1 = end1.minus(test);
//  //vel1.clampToLength(1);
//  //Vec2 vel2 = test.minus(end1);
//  //vel2.clampToLength(1);
//  //System.out.println(computeTTC(test, vel1, 1.0, end1, vel2, 1.0));
...
//  ttc = ttc < 0 ? -1 : ttc;
//  return ttc; // return -1 if ttc < 0, otherwise return ttc
//}
...
//  Vec2 acc = new Vec2(0,0); // final output acceleration
  
//  Vec2 targetVel = goalPos[id].minus(agentPos[id]); // calculate targetVel
//  Vec2 goalSpeedForce = targetVel.minus(agentVel[id]);
//  acc.add(goalSpeedForce.times(k_goal));
  
//  if (targetVel.length() < 5) return acc;
...
//    Vec2 avoidDir = futurePos_id.minus(futurePos_j).normalized(); // the future vec relative to the 2 at poc
//    Vec2 avoidanceForce = avoidDir.times(1/ttc);
//    if (ttc > 0){ // only account for the other agent if there'll be an impact
//      acc.add(avoidanceForce.times(k_avoid));
//    }
//  } // end for
//  return acc;
//}
...
//  fill(20,200,150);
//  for (int i = 0; i < numAgents; i++){
//    circle(agentPos[i].x, agentPos[i].y, agentRad*1.95);
//  }
//}
